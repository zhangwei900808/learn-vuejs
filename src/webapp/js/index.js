...
/******/ 			script.src = __webpack_require__.p + "" + chunkId + "." + ({"1":"vuecs"}[chunkId]||chunkId) + ".js";
...
/***/ function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/zhangwei/Work/Web/Vuejs/src/components/login/user-nav.vue";
	...
	if (false) {
	  (function () {
	    ...
	    module.hot.accept();
	    if (!module.hot.data) {
	      hotAPI.createRecord("data-v-2bbbf3d4", __vue_options__);
	    } else {
	      hotAPI.reload("data-v-2bbbf3d4", __vue_options__);
	    }
	  })();
	}
	if (__vue_options__.functional) {
	  console.error("[vue-loader] user-nav.vue: functional components are not supported and should be defined in plain js files using render functions.");
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {
	  module.hot.accept()
	  if (module.hot.data) {
	     require("vue-hot-reload-api").rerender("data-v-2bbbf3d4", module.exports)
	  }
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/zhangwei/Work/Web/Vuejs/src/components/login/user-news-detail.vue";
	__vue_options__.render = __vue_template__.render;
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns;
	...
	if (false) {
	  (function () {
	    ...
	    module.hot.accept();
	    if (!module.hot.data) {
	      hotAPI.createRecord("data-v-9ff93b88", __vue_options__);
	    } else {
	      hotAPI.reload("data-v-9ff93b88", __vue_options__);
	    }
	  })();
	}
	if (__vue_options__.functional) {
	  console.error("[vue-loader] user-news-detail.vue: functional components are not supported and should be defined in plain js files using render functions.");
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;
	  ...
	  }, [_h('h2', [" " + _vm._s(_vm.newsdetail.title), _h('small', [_vm._s(_vm.newsdetail.pubtime)])]), " ", _h('p', ["\n        " + _vm._s(_vm.newsdetail.desc) + "\n      "])])])])
	},staticRenderFns: []}
	module.exports.render._withStripped = true
	if (false) {
	  module.hot.accept()
	  if (module.hot.data) {
	     require("vue-hot-reload-api").rerender("data-v-9ff93b88", module.exports)
	  }
	}
